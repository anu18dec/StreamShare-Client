function RoomMembers({ roomMembers, isOwner, curSocketId }) {
    return (
        <div className="flex items-center gap-2">
            <img src="/avatar.png" alt="user" className="w-10 h-10 rounded-full" />
            <div className="flex justify-between items-center w-full">
                <span className="text-base font-medium text-black">{roomMembers.username}</span>

                {/* {isOwner && roomMembers.socketId != curSocketId && (
