function FileBar({ file, progress }) {
    return (
        <div className="flex flex-col hover:bg-gray-100">
            <div className="flex w-full p-2 justify-between gap-2.5 ">
                <div className="flex items-center gap-3">
                    ...
                    <span className="break-all">conten suhasjhas ashjhjash-jasj-script.txt</span>
                </div>
                <div className="flex items-center">
                    <p className="text-md dark:text-white">File size: 455KB</p>
                </div>
                <div className="">
                    <button className="rounded bg-blue-600 py-1 px-3 font-medium text-white hover:bg-opacity-90 sm:py-2.5 sm:px-6">
                        Send
                    </button>
                </div>
            </div>
